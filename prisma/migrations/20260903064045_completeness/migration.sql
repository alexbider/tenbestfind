...
INSERT INTO "new_Business" ("addressLine", "awards", "bestFor", "brands", "categoryId", "cityId", "claimed", "considerations", "createdAt", "description", "editorialTake", "email", "emailSource", "emergency", "employeeCount", "financing", "freeEstimates", "gmbQuery", "gmbRank", "googleDataUpdated", "googleDistribution", "googleRating", "googleReviewCount", "hours", "id", "importedAt", "insured", "latitude", "licenseNumber", "logoUrl", "longitude", "name", "overview", "ownerId", "paymentMethods", "phone", "placeId", "postalCode", "publishedAt", "reviewsUpdatedAt", "siteCrawledAt", "slug", "socialLinks", "status", "strengths", "stripeCustomerId", "submittedAt", "tagline", "updatedAt", "verified", "warrantyTerms", "website", "yearFounded") SELECT "addressLine", "awards", "bestFor", "brands", "categoryId", "cityId", "claimed", "considerations", "createdAt", "description", "editorialTake", "email", "emailSource", "emergency", "employeeCount", "financing", "freeEstimates", "gmbQuery", "gmbRank", "googleDataUpdated", "googleDistribution", "googleRating", "googleReviewCount", "hours", "id", "importedAt", "insured", "latitude", "licenseNumber", "logoUrl", "longitude", "name", "overview", "ownerId", "paymentMethods", "phone", "placeId", "postalCode", "publishedAt", "reviewsUpdatedAt", "siteCrawledAt", "slug", "socialLinks", "status", "strengths", "stripeCustomerId", "submittedAt", "tagline", "updatedAt", "verified", "warrantyTerms", "website", "yearFounded" FROM "Business";
DROP TABLE "Business";
...
CREATE INDEX "Business_completeness_idx" ON "Business"("completeness");
